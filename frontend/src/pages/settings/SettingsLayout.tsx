...
// rules it files music by, then the metadata it fetches, then where music
// comes from, then the services it talks to, then what it deleted. Account is last because it is the one section
...
const SETTINGS_SECTIONS = [
  ...
  { label: "Sources", to: "/settings/sources" },
