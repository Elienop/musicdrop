...
- **Folder sources** (**Settings → Sources**) — name the folders you import from often; a folder must exist and is refused where an import would refuse it (the library, MusicDrop's own folders, slskd's whole folder). Removing one touches no files.
