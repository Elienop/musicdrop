...
The password guards more than your library. Settings → Beets can enable any beets plugin, and
some run shell commands (`hook`, `convert`, `play`), so a signed-in session can run commands in
the container.
